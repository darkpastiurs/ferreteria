 ...
 * @author HP
 */
public class RegMarcas extends javax.swing.JPanel {

    /**
     * Creates new form RegMarcas
     */
     ...
     tblMarca.setFillsViewportHeight(true);
        ...
        txtBuscar.addKeyListener(new KeyAdapter() {
            ...
            public void keyReleased(KeyEvent e) {
                listadoModel=mi.actualizarDatos.apply(tblMarca);
                List<Marca> busqueda=listadoModel.stream().filter(m->{
                ...
                mostrarCoincidencias.accept(tblMarca,busqueda);
            }
        });
        ...
        tblMarca.addMouseListener(new MouseAdapter(){
            ...
            public void mouseClicked(MouseEvent e){
                try {
                    int i= tblMarca.getSelectedRow();
                    ID =Long.valueOf(tblMarca.getValueAt(i,0).toString());
                }catch(ArrayIndexOutOfBoundsException e1){
                }
            }
        });
    }
    Consumer<JTable> mostrarMarcas=(t)->{
        listadoModel=mi.actualizarDatos.apply(t);
            mi.actualizarDatos.apply(t);
    };
    BiConsumer<JTable,List<Marca>> mostrarCoincidencias=(t, l)->{
            mi.mostrarCoincidencias.accept(t,l);
    };
    public void limpiar(){
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(756, 638));

        jPanel1.setBackground(new java.awt.Color(0, 204, 204));
        jPanel1.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jLabel1.setFont(new java.awt.Font("Tahoma", 2, 14)); // NOI18N
        jLabel1.setText("Inicio/Registros/Registro de Marcas");
